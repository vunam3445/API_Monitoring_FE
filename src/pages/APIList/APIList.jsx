    ...
    return (
        <div className="space-y-8">
            ...
            <div className="flex flex-wrap items-center justify-between gap-4">
                ...
                <button className="bg-primary hover:bg-primary/90 text-white px-6 py-2.5 rounded-xl font-bold flex items-center gap-2 shadow-lg shadow-primary/20 transition-all active:scale-95">
