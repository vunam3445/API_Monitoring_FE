...
const MonitoringSummaryCards = () => {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm flex items-center gap-4">
                <div className="p-4 bg-amber-50 dark:bg-amber-900/20 rounded-2xl text-amber-600 shrink-0">
                    <span className="material-symbols-outlined text-3xl">warning</span>
                </div>
                <div>
                    <p className="text-sm font-bold text-slate-500 mb-1">Warning</p>
                    <p className="text-3xl font-black text-slate-900 dark:text-white leading-none">3</p>
                    <span className="text-xs text-amber-600 font-bold mt-2 block">Latency spikes detected</span>
                </div>
            </div>
